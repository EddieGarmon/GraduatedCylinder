...
{
    /// <summary>
    ///     This dimension represents an angle.
    /// </summary>
    public class Angle : Dimension, IEquatable<Angle>, IComparable<Angle>
    {
        ...
        public static Angle operator +(Angle angle1, Angle angle2) {
            ...
            return new Angle(angle1.ValueInBaseUnits + angle2.ValueInBaseUnits) {Units = angle1.Units};
        }
        ...
        public static Angle operator /(Angle angle, double scaler) {
            ...
            return new Angle(angle.ValueInBaseUnits / scaler) {Units = angle.Units};
        }
