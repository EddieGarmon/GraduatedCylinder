...
namespace GraduatedCylinder
{
	public class MassFlowRateConversionsFixture
	{
		...
		public void MassFlowRateConversions(double value1, MassFlowRateUnit units1, double value2, MassFlowRateUnit units2) {
			new MassFlowRate(value1, units1) {Units = units2}.Value.ShouldBeWithinEpsilonOf(value2);
			new MassFlowRate(value2, units2) {Units = units1}.Value.ShouldBeWithinEpsilonOf(value1);
		}
	}
}