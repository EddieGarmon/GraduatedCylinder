...
namespace GraduatedCylinder
{
	...
	{
		[Theory]
		[InlineData(5897.56, PressureUnit.Pascals, 40662244.7462604526, PressureUnit.PoundsPerSquareInch)]
		...
		public void PressureConversions(double value1, PressureUnit units1, double value2, PressureUnit units2) {
			new Pressure(value1, units1) {Units = units2}.Value.ShouldBeWithinEpsilonOf(value2);
			new Pressure(value2, units2) {Units = units1}.Value.ShouldBeWithinEpsilonOf(value1);
		}
	}
}