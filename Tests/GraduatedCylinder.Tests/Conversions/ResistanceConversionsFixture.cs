...
public class ResistanceConversionsFixture
{
    ...
    public void ResistanceConversions(double value1, ElectricResistanceUnit units1, double value2, ElectricResistanceUnit units2) {
        new ElectricResistance(value1, units1).In(units2).Value.ShouldBeWithinToleranceOf(value2);
        new ElectricResistance(value2, units2).In(units1).Value.ShouldBeWithinToleranceOf(value1);
    }
