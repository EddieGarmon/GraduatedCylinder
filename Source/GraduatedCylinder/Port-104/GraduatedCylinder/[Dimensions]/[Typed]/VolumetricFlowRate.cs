...
{
    /// <summary>
    ///     Represents Volumetric Flow Rate Dimension.
    /// </summary>
    public class VolumetricFlowRate : Dimension, IEquatable<VolumetricFlowRate>, IComparable<VolumetricFlowRate>
    {
        ...
        public static VolumetricFlowRate operator /(VolumetricFlowRate volumetricFlowRate, double scaler) {
            ...
            return new VolumetricFlowRate(volumetricFlowRate.ValueInBaseUnits / scaler) { Units = volumetricFlowRate.Units };
        }
        ...
        public static Volume operator *(VolumetricFlowRate volumetricFlowRate, Time time) {
            ...
            double volumeValue = volumetricFlowRate.In(VolumetricFlowRateUnit.CubicMetersPerSecond) * time.In(TimeUnit.Seconds);
