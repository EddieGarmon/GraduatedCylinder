...
namespace GraduatedCylinder
{
    ...
    /// </summary>
    public class Jerk : Dimension, IEquatable<Jerk>, IComparable<Jerk>
    {
        ...
        public static Jerk operator +(Jerk left, Jerk right) {
            ...
            return new Jerk(left.ValueInBaseUnits + right.ValueInBaseUnits) { Units = left.Units };
        }

        public static Jerk operator /(Jerk jerk, double scaler) {
            Guard.NotNull(jerk, "jerk");
            return new Jerk(jerk.ValueInBaseUnits / scaler) { Units = jerk.Units };
        }
        ...
        public static Acceleration operator *(Jerk jerk, Time time) {
            ...
            double accelerationValue = jerk.In(JerkUnit.MetersPerSecondCubed) * time.In(TimeUnit.Seconds);
        ...
        public static Jerk operator -(Jerk jerk1, Jerk jerk2) {
            ...
            return new Jerk(jerk1.ValueInBaseUnits - jerk2.ValueInBaseUnits) { Units = jerk1.Units };
        }
    }
}