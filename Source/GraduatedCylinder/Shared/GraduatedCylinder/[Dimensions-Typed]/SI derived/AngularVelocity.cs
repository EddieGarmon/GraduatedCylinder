...
{
    public class AngularVelocity : Dimension,
                                   ...
                                   IComparable<AngularVelocity>
    {
        ...
        public double In(AngularVelocityUnit units) {
            return base.In(units);
        }

        public string ToString(AngularVelocityUnit units) {
            return base.ToString(units);
        }

        public string ToString(AngularVelocityUnit units, int precision) {
        ...
        public static AngularVelocity operator +(AngularVelocity revolutions1, AngularVelocity revolutions2) {
            ...
            return new AngularVelocity(revolutions1.ValueInBaseUnits + revolutions2.ValueInBaseUnits) {
                Units = revolutions1.Units
            };
        }
        ...
        public static AngularVelocity operator /(AngularVelocity angularVelocity, double scaler) {
            ...
            return new AngularVelocity(angularVelocity.ValueInBaseUnits / scaler) {
                Units = angularVelocity.Units
            };
        }
