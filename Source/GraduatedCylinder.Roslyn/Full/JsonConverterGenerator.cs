...
public class JsonConverterGenerator : BaseGenerator
{
    ...
    private void GenerateJsonConverter(StructDeclarationSyntax @struct) {
        string filename = $"Source\\GraduatedCylinder.Json\\{@struct.Identifier}JsonConverter.g.cs";
        ...
        Buffer.AppendLine("\t\t}");
        Buffer.AppendLine($"\t\treturn {@struct.Identifier}.Parse(value);");
        Buffer.AppendLine("\t}");
        Buffer.AppendLine();
        Buffer.AppendLine(
    ...
    private void GenerateJsonHelper(DimensionReceiver receiver, Compilation compilation) {
        string filename = "Source\\GraduatedCylinder.Json\\JsonHelper.g.cs";
