...
[Generator]
public class UnitConverter32Generator : BaseGenerator
{

    public UnitConverter32Generator()
        ...
        foreach (EnumMemberDeclarationSyntax enumMember in @enum.Members) {
            ...
            switch (attribute.AttributeClass?.Name) {
                case "ScaleAttribute":
                    ...
                    Buffer.AppendLine($"\t\t\t\t\tnewValue = baseValue / {attribute.ConstructorArguments[0].Value}f;");
                    break;
