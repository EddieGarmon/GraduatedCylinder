...
//		private readonly OutputParser _parser = new OutputParser();
...
//				SendCommand(Commands.MeasurementMode.GetReadCommand());
//				Sentence response = next.First();
//				return (MeasurementMode)Enum.Parse(typeof(MeasurementMode), response.Raw.Substring(4));
//			}
//			set {
//				string command = Commands.MeasurementMode.GetWriteCommand(value);
//				SendCommand(command);
//			}
//		}
...
//				SendCommand(Commands.TargetMode.GetReadCommand());
//				Sentence response = next.First();
//				return (TargetMode)Enum.Parse(typeof(TargetMode), response.Raw.Substring(4));
//			}
//			set {
//				string command = Commands.TargetMode.GetWriteCommand(value);
//				SendCommand(command);
//			}
//		}
...
//			if (autoFire) {
//				SendCommand(Commands.Start.GetReadCommand());
//			}
//			Message message = next.First();
...
//			SendCommand(Commands.BatteryVoltage.GetReadCommand());
//			Sentence response = next.First();
...
//		public void TurnOff() {
//			if (IsConnected) {
//				SendCommand(Commands.PowerOff.GetReadCommand());
//			}
//		}

//		private void InitializeSettings() {
//			//read some settings
//			SendCommand(Commands.Id.GetReadCommand());

//			//set some others
//			SendCommandAndWaitForOk(Commands.AngleUnits.GetWriteCommand(AngleUnitsMode.Degrees));
//			SendCommandAndWaitForOk(Commands.DistanceUnits.GetWriteCommand(DistanceUnitsMode.Meters));
//		}
