...
namespace GraduatedCylinder
{
    public class TemperatureConversionsFixture
    {
        ...
        public void TemperatureConversions(double value1, TemperatureUnit units1, double value2, TemperatureUnit units2) {
            new Temperature(value1, units1) {Units = units2}.Value.ShouldBeWithinEpsilonOf(value2);
            new Temperature(value2, units2) {Units = units1}.Value.ShouldBeWithinEpsilonOf(value1);
        }
    }
}