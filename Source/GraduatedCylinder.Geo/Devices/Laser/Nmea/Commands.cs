...
namespace GraduatedCylinder.Devices.Laser.Nmea
{
    internal static class Commands
    {
        ...
        internal static readonly CommandSentence<DistanceUnitsMode> DistanceUnits =
            new CommandSentence<DistanceUnitsMode>("DU");

        internal static readonly CommandSentence Id = new CommandSentence("ID");

        internal static readonly CommandSentence<MeasurementMode> MeasurementMode =
            new CommandSentence<MeasurementMode>("MM");
